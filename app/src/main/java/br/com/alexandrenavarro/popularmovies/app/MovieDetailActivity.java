...
import br.com.alexandrenavarro.popularmovies.app.data.MovieManager;
...
public class MovieDetailActivity extends AppCompatActivity implements OnResponse, View.OnClickListener {
    ...
    LinearLayout mContainerTrailers;
    ...
    public void onFavoriteClicked(Button button) {
        MovieManager.insertFavorite(getApplicationContext(), mMovie);
    }
